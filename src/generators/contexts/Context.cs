...
{
    public static void Generate(JsonObject paths, JsonObject? schemas, string contextsOutputDir, HashSet<string>? blacklist = null, string? templatePath = null, HashSet<string>? apiPrefixes = null)
    {
